  ...
  return (
    <>
      <div style={isOpen ? { zoom: 0.97 } : { zoom: 1 }} className="relative min-h-screen bg-[url('/background.png')] bg-no-repeat bg-center bg-origin-border bg-local text-white transition-all duration-500 ease-in-out">
        ...
        <div className="w-28 h-28 bg-gradient-to-b from-[#7F1E7B] to-[#19073B] opacity-40 z-[0] rounded-full absolute top-0 left-5 sm:top-8 sm:left-56 md:top-8 md:left-56"></div>
        <div className="w-20 h-20 bg-gradient-to-b from-[#213F72] to-[#19073B] opacity-40 z-[0] rounded-full absolute top-48 right-80"></div>
        <div className="w-40 h-40 bg-gradient-to-b from-[#7F4129] to-[#1C0C28] opacity-40 z-[0] rounded-full absolute -bottom-16 left-1/4"></div>
      </div>
    </>
  )
}