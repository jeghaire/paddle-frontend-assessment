...
export default function Contact() {
  ...
  return (
    <>
      <form className="-z-20 bg-gradient-to-bl from-[#210045] to-[#0C0123] m-0 p-6 pb-20 sm:p-32 pt-36 sm:pl-16  w-full h-full text-white" onSubmit={handleSignUp}>
        ...
        <div className="w-36 h-36 bg-gradient-to-b from-[#213F72] to-[#19073B] opacity-60 rounded-full absolute top-60 sm:top-68 right-10 sm:right-48 -z-10" />
        ...
        <div className="w-full mt-6">
          ...
          <input
            type="text"
            className="w-full bg-white placeholder:capitalize rounded-xl py-5 px-8 text-sm font-thin placeholder:font-thin leading-6 text-black placeholder:text-slate-700 shadow-sm outline-none lg:flex z-0"
